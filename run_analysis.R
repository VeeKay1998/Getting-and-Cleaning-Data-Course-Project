...
sub.train <- read.table("C:\\Users\\Venkat koushik\\R\\UCI HAR Dataset\\train\\subject_train.txt")
sub.test <- read.table("C:\\Users\\Venkat koushik\\R\\UCI HAR Dataset\\test\\subject_test.txt")
y.train <- read.table("C:\\Users\\Venkat koushik\\R\\UCI HAR Dataset\\train\\Y_train.txt")
y.test <- read.table("C:\\Users\\Venkat koushik\\R\\UCI HAR Dataset\\test\\Y_test.txt")
var.names <- read.table("C:\\Users\\Venkat koushik\\R\\UCI HAR Dataset\\features.txt")
...
act.labels <- read.table("C:\\Users\\Venkat koushik\\R\\UCI HAR Dataset\\activity_labels.txt")
